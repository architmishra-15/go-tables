...
func main() {
	// Basic separator between groups
	...
	// Separator with colors works naturally — cell content is independent of
	// separator lines, so ANSI sequences in data rows are unaffected.
